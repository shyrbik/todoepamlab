...
//track If a field’s value changes, and the field is used in a template or in a getter of a property that’s used
// in a template, the component rerenders and displays the new value.
export default class toDoManager extends LightningElement {
    ...
    addTodoHandler() {
        ...
        //this.template.querySelector - To access elements rendered by a component, use the template property.
